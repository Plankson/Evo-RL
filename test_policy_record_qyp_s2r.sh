...
PIPER_SPEED_RATIO="${PIPER_SPEED_RATIO:-50}"
PIPER_HIGH_FOLLOW="${PIPER_HIGH_FOLLOW:-true}"
...
OPENVLA_OFT_MAX_JOINT_DELTA_RAD="${OPENVLA_OFT_MAX_JOINT_DELTA_RAD:-0.03}"
OPENVLA_OFT_MAX_GRIPPER_DELTA="${OPENVLA_OFT_MAX_GRIPPER_DELTA:-0.006}"
